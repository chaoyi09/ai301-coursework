...
I work mainly in Python and am comfortable with pytest and text/string processing. I would like to get better at RAG and ingestion pipeline code — document parsing, chunking, and how text gets prepared for retrieval. I prefer issues in the ingestion/ and rag/ modules. I have some React experience but would rather not take a frontend-heavy issue for my first contribution, and I want to avoid anything needing deep DevOps or CI infrastructure knowledge.
